...
/**
 * View: VideoEnabledWebChromeClient
 * Description: 自定义WebChromeClient，支持视频的全屏播放。
 *
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener {
	...
	private List<View> nonVideoViewList;
     ...
     * @param nonVideoViewList A View in the activity's layout that contains every other view that should be hidden when the video goes full-screen.
     * @param activityVideoView A ViewGroup in the activity's layout that will display the video. Typically you would like this to fill the whole layout. 
     */ 
    public VideoEnabledWebChromeClient(List<View> nonVideoViewList, ViewGroup activityVideoView) { 
    	this.nonVideoViewList = nonVideoViewList;
     ...
     */ 
    public VideoEnabledWebChromeClient(List<View> nonVideoViewList, ViewGroup activityVideoView, View loadingView) 
    { 
    	this.nonVideoViewList = nonVideoViewList;
        this.activityVideoView = activityVideoView; 
     ...
     */ 
    public VideoEnabledWebChromeClient(List<View> nonVideoViewList, ViewGroup activityVideoView, View loadingView, VideoEnabledWebView webView) 
    { 
    	this.nonVideoViewList = nonVideoViewList;
        this.activityVideoView = activityVideoView; 
        this.loadingView = loadingView; 
    ...
    { 
        ...
        { 
            ...
            if(nonVideoViewList != null && nonVideoViewList.size() > 0) {
                for (View aView : nonVideoViewList) {
    ...
    { 
        ...
        { 
            ...
            if(nonVideoViewList != null && nonVideoViewList.size() > 0) {
                for (View view : nonVideoViewList) {
