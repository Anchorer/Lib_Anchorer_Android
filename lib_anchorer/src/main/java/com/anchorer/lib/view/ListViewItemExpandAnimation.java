 ...
 * 
 */
public class ListViewItemExpandAnimation extends Animation {
	 ...
	 */
	public ListViewItemExpandAnimation(View view, int duration, boolean isVisibleAfter,
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		if (interpolatedTime < 1.0f) {
			...
			mAnimatedView.requestLayout();
			mAnimatedView.setVisibility(mIsVisibleAfter ? View.VISIBLE : View.GONE);
